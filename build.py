# -*- coding: UTF-8 -*-
"""
打包脚本：把 siwu-bili-dynamic-watcher 插件源码打包为 zip，用于 AstrBot 网页端上传安装。

版本号自动读取自 metadata.yaml 中的 version，输出 dist/siwu-bili-dynamic-watcher-<version>.zip
...
PLUGIN_SLUG = "siwu-bili-dynamic-watcher"
